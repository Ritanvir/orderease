...
if(isset($_POST['submit'])){
   ...
   if($select_user->rowCount() > 0){
      ...
      if($pass != $cpass){
         ...
         $insert_user = $conn->prepare("INSERT INTO `users`(name,address, email, number, password) VALUES(?,?,?,?,?)");
         $insert_user->execute([$name,$address, $email, $number, $cpass]);
...
<section class="form-container">
   ...
   <form action="" method="post">
      ...
      <input type="text" name="address" required placeholder="enter your address" class="box" maxlength="50">
