...
if(isset($_POST['submit'])){
   ...
   if($check_cart->rowCount() > 0){
      ...
      if($method== 'cash on delivery'){
         ...
         $stripe_secret_key = "sk_test_51PD5FeLVdhj66zM48uVijuQv1rqpPGzipwo3L1qs44xqvdTsshzRNyqv1BE8QjXeLX5hXQiPdF7z7O4DtUpnadBB009G4zFm5S";
...
$checkout_session = \Stripe\Checkout\Session::create([
   ...
   'mode' => 'payment',
   "success_url" => "http://localhost/orderease/success.php",
   "cancel_url" => "http://localhost/home.php",
 ]);
